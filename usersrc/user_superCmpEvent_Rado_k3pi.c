...
static int nuserevt=0;
  ...
  //cout << "PROBLEMMMMMMMM" << eltrkindx1 << eltrkindx2 << muchtrkindx << odd_track << endl;
  ...
  if(sevt->track[muchtrkindx].q * (sevt->track[muchtrkindx].q + sevt->track[eltrkindx1].q + sevt->track[eltrkindx2].q) == -1){
      odd_track==muchtrkindx;
      ((TH1F*)gDirectory->FindObject(h_piodd_eovp->GetName()))->Fill(eop_mu_track);
  } else if (sevt->track[eltrkindx1].q * (sevt->track[muchtrkindx].q + sevt->track[eltrkindx1].q + sevt->track[eltrkindx2].q) == -1){
     odd_track==eltrkindx1;
     ((TH1F*)gDirectory->FindObject(h_piodd_eovp->GetName()))->Fill( eop_e1_track);
  }  else if (sevt->track[eltrkindx2].q * (sevt->track[muchtrkindx].q + sevt->track[eltrkindx1].q + sevt->track[eltrkindx2].q) == -1){
     odd_track==eltrkindx2;
     ((TH1F*)gDirectory->FindObject(h_piodd_eovp->GetName()))->Fill( eop_e2_track);
  } 
  //if(sevt->track[i].q*sevt->vtx[0].charge < 0){
  ...
  if (nelectrack==2 && muchtrkindx!=-1) {
	...
	((TH2F*)gDirectory->FindObject(h_eop_vs_Pt->GetName()))->Fill(eop_e2_track,el2lv->Pt() );
      } else {
	((TH2F*)gDirectory->FindObject(h_eop_vs_Pt->GetName()))->Fill(eop_e1_track, el1lv->Pt());
	  }
