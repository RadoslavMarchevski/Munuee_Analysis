...
void FillTriggerHistos(Hist_dir* dir, superCmpEvent* sevt, superBurst* sbur);
...
int user_superCmpEvent(superBurst *sbur,superCmpEvent *sevt) {
  ...
  if(pi1 != -1 && pi2 != -1 && pi3 != -1){
    ...
    TLorentzVector pKaonK3pi;
    pKaonK3pi.SetPxPyPzE(0,0,60.,sqrt(60*60 + massKaonC*massKaonC));

    TLorentzVector PK3pi = pion1.Momentum + pion2.Momentum + pion3.Momentum;
    TLorentzVector PK3piPee = pion2.Momentum + pion3.Momentum;
    TLorentzVector PK3piPnu = pKaonK3pi - pion1.Momentum - pion2.Momentum - pion3.Momentum;


    int Vp12 = closap_double_(pion1.Position,pion2.Position,pion1.Slopes,pion2.Slopes,&cda_pi1_pi2,Vertex_pi1_pi2);
    int Vp13 = closap_double_(pion1.Position,pion3.Position,pion1.Slopes,pion3.Slopes,&cda_pi1_pi3,Vertex_pi1_pi3);
    int Vp23 = closap_double_(pion2.Position,pion3.Position,pion2.Slopes,pion3.Slopes,&cda_pi2_pi3,Vertex_pi2_pi3);
    ...
    double K3pi_Event_Pi1HoDTime;
    double K3pi_Event_Pi2HoDTime;
    double K3pi_Event_Pi3HoDTime;

    double K3pi_Event_Pi1DCHTime;
    double K3pi_Event_Pi2DCHTime;
    double K3pi_Event_Pi3DCHTime;

    K3pi_Event_Pi1HoDTime = ( (pion1.GetHodTime() + pion2.GetHodTime() + pion3.GetHodTime() )/3 -  pion1.GetHodTime());
    K3pi_Event_Pi2HoDTime = ( (pion1.GetHodTime() + pion2.GetHodTime() + pion3.GetHodTime() )/3 -  pion2.GetHodTime());
    K3pi_Event_Pi3HoDTime = ( (pion1.GetHodTime() + pion2.GetHodTime() + pion3.GetHodTime() )/3 -  pion3.GetHodTime());


    K3pi_Event_Pi1DCHTime = ( (pion1.GetDCHtime() + pion2.GetDCHtime() + pion3.GetDCHtime() )/3 -  pion1.GetDCHtime());
    K3pi_Event_Pi2DCHTime = ( (pion1.GetDCHtime() + pion2.GetDCHtime() + pion3.GetDCHtime() )/3 -  pion2.GetDCHtime());
    K3pi_Event_Pi3DCHTime = ( (pion1.GetDCHtime() + pion2.GetDCHtime() + pion3.GetDCHtime() )/3 -  pion3.GetDCHtime());

    if(fabs(K3pi_Event_Pi1HoDTime) > fabs(K3pi_Event_Pi2HoDTime) && fabs(K3pi_Event_Pi1HoDTime) > fabs(K3pi_Event_Pi3HoDTime) )
      K3pi_Event_HoDTime = K3pi_Event_Pi1HoDTime ;

    if(fabs(K3pi_Event_Pi2HoDTime) > fabs(K3pi_Event_Pi1HoDTime) && fabs(K3pi_Event_Pi1HoDTime) > fabs(K3pi_Event_Pi3HoDTime) )
      K3pi_Event_HoDTime = K3pi_Event_Pi2HoDTime ;

    if( fabs(K3pi_Event_Pi3HoDTime) > fabs(K3pi_Event_Pi1HoDTime) && fabs(K3pi_Event_Pi1HoDTime) > fabs(K3pi_Event_Pi2HoDTime) )
      K3pi_Event_HoDTime = K3pi_Event_Pi3HoDTime ;


    if(fabs(K3pi_Event_Pi1DCHTime) > fabs(K3pi_Event_Pi2DCHTime) && fabs(K3pi_Event_Pi1DCHTime) > fabs(K3pi_Event_Pi3DCHTime) )
      K3pi_Event_DCHTime = K3pi_Event_Pi1DCHTime ;

    if(fabs(K3pi_Event_Pi2DCHTime) > fabs(K3pi_Event_Pi1DCHTime) && fabs(K3pi_Event_Pi1DCHTime) > fabs(K3pi_Event_Pi3DCHTime) )
      K3pi_Event_DCHTime = K3pi_Event_Pi2DCHTime ;

    if( fabs(K3pi_Event_Pi3DCHTime) > fabs(K3pi_Event_Pi1DCHTime) && fabs(K3pi_Event_Pi1DCHTime) > fabs(K3pi_Event_Pi2DCHTime) )
      K3pi_Event_DCHTime = K3pi_Event_Pi3DCHTime ;
    ...
    if(PK3pi.P() > 52. &&
      ...
      K3pi_selection->FillHist(PK3pi,PK3piPnu, Kcharge);
      ...
      FillTriggerHistos(K3pi_selection, sevt, sbur);
      ...
      //K3pi intime
      if(fabs(K3pi_Event_HoDTime) < 3){
        K3pi_intime->FillCommonHist(sevt);
        FillTriggerHistos(K3pi_intime, sevt, sbur);

        K3pi_intime->FillHist(pion1,"pion1");
        K3pi_intime->FillHist(pion2,"pion2");
        K3pi_intime->FillHist(pion3,"pion3");

        K3pi_intime->FillHist(PK3pi,PK3piPnu, Kcharge);
        K3pi_intime->fh_Kaon_Charge->Fill(Kcharge);
        K3pi_intime->fh_Event_Type->Fill(K3pi_Event_Type);
        K3pi_intime->fh_HoDTotTime->Fill( K3pi_Event_HoDTime );
        K3pi_intime->fh_DCHTotTime->Fill( K3pi_Event_DCHTime );
        if(IS_DATA){
          if(pion1.GetEnergyLeftInEcal()/ pion1.GetMomentum() > 0.95 && pion1.GetEnergyLeftInEcal()/ pion1.GetMomentum() < 1.05 ) {

            K3pi_intime->fh_lda3_p1->Fill(lda3_pi1);
            //K3pi_intime ->fh_lda3_p1->Fill(1.);
            //cout << lda3_pi1 << endl;
          } else if(pion2.GetEnergyLeftInEcal()/ pion2.GetMomentum() > 0.95 && pion2.GetEnergyLeftInEcal()/ pion2.GetMomentum() < 1.05 ) {
            K3pi_intime->fh_lda3_p2->Fill(lda3_pi2);
          } else if(pion3.GetEnergyLeftInEcal()/ pion3.GetMomentum() > 0.95 && pion3.GetEnergyLeftInEcal()/ pion3.GetMomentum() < 1.05 ) {
            K3pi_intime->fh_lda3_p3->Fill(lda3_pi3);
          }
        }
        //K3pi_intime ->fh_lda3_p3->Fill(lda3_pi3);


        K3pi_intime->FillVertexHist(Vertex_pi1_pi2, cda_pi1_pi2 , Vertex_pi2_pi3, cda_pi2_pi3, Vertex_pi1_pi3, cda_pi1_pi3,"K3pi");

        if(Kcharge>0){
          K3pi_intime->fh_M3pi_Kplus->Fill(PK3pi.M());
        }

        if(Kcharge<0){
          K3pi_intime->fh_M3pi_Kminus->Fill(PK3pi.M());
        }

        if(magnetCurrent < 0){
          K3pi_intime->fh_M3pi_magnet_minus->Fill(PK3pi.M());
        }
        if(magnetCurrent > 0){
          K3pi_intime->fh_M3pi_magnet_plus->Fill(PK3pi.M());
        }
        if(AchromatCurrent < 0) {
          K3pi_intime->fh_M3pi_Aminus->Fill(PK3pi.M());
        }
        if(AchromatCurrent > 0) {
          K3pi_intime->fh_M3pi_Aplus->Fill(PK3pi.M());
        }


        if(Kcharge*pion1.GetCharge()==-1 && sevt->track[pi1].iMuon != -1){
          K3pi_intime->fh_odd_eop->Fill(pion1.GetEnergyLeftInEcal()/ pion1.GetMomentum());
          K3pi_intime->fh_EoP_vs_p_odd_tr->Fill(pion1.GetEnergyLeftInEcal()/ pion1.GetMomentum(), pion1.GetMomentum());
        } else if(Kcharge*pion2.GetCharge()==-1 && sevt->track[pi2].iMuon != -1) {
          K3pi_intime->fh_odd_eop->Fill(pion2.GetEnergyLeftInEcal()/ pion2.GetMomentum());
          K3pi_intime->fh_EoP_vs_p_odd_tr->Fill(pion2.GetEnergyLeftInEcal()/ pion2.GetMomentum(), pion2.GetMomentum());
        } else if(Kcharge*pion3.GetCharge()==-1 && sevt->track[pi3].iMuon != -1){
          K3pi_intime->fh_odd_eop->Fill(pion3.GetEnergyLeftInEcal()/ pion3.GetMomentum());
          K3pi_intime->fh_EoP_vs_p_odd_tr->Fill(pion3.GetEnergyLeftInEcal()/ pion3.GetMomentum(), pion3.GetMomentum());
      ...
      ////K3pi accidentals
      if(fabs(K3pi_Event_HoDTime) > 3){
        K3pi_accidentals->FillCommonHist(sevt);
        FillTriggerHistos(K3pi_accidentals, sevt, sbur);

        K3pi_accidentals->FillHist(pion1,"pion1");
        K3pi_accidentals->FillHist(pion2,"pion2");
        K3pi_accidentals->FillHist(pion3,"pion3");

        K3pi_accidentals->FillHist(PK3pi,PK3piPnu, Kcharge);
        K3pi_accidentals->fh_Kaon_Charge->Fill(Kcharge);
        K3pi_accidentals->fh_Event_Type->Fill(K3pi_Event_Type);
        K3pi_accidentals->fh_HoDTotTime->Fill( K3pi_Event_HoDTime );
        K3pi_accidentals->fh_DCHTotTime->Fill( K3pi_Event_DCHTime );
        if(IS_DATA){
          if(pion1.GetEnergyLeftInEcal()/ pion1.GetMomentum() > 0.95 && pion1.GetEnergyLeftInEcal()/ pion1.GetMomentum() < 1.05 ) {

            K3pi_accidentals->fh_lda3_p1->Fill(lda3_pi1);
            //K3pi_accidentals->fh_lda3_p1->Fill(1.);
            //cout << lda3_pi1 << endl;
          } else if(pion2.GetEnergyLeftInEcal()/ pion2.GetMomentum() > 0.95 && pion2.GetEnergyLeftInEcal()/ pion2.GetMomentum() < 1.05 ) {
            K3pi_accidentals->fh_lda3_p2->Fill(lda3_pi2);
          } else if(pion3.GetEnergyLeftInEcal()/ pion3.GetMomentum() > 0.95 && pion3.GetEnergyLeftInEcal()/ pion3.GetMomentum() < 1.05 ) {
            K3pi_accidentals->fh_lda3_p3->Fill(lda3_pi3);
          }
        }
        //K3pi_accidentals->fh_lda3_p3->Fill(lda3_pi3);


        K3pi_accidentals->FillVertexHist(Vertex_pi1_pi2, cda_pi1_pi2 , Vertex_pi2_pi3, cda_pi2_pi3, Vertex_pi1_pi3, cda_pi1_pi3,"K3pi");

        if(Kcharge>0){
          K3pi_accidentals->fh_M3pi_Kplus->Fill(PK3pi.M());
        }

        if(Kcharge<0){
          K3pi_accidentals->fh_M3pi_Kminus->Fill(PK3pi.M());
        }

        if(magnetCurrent < 0){
          K3pi_accidentals->fh_M3pi_magnet_minus->Fill(PK3pi.M());
        }
        if(magnetCurrent > 0){
          K3pi_accidentals->fh_M3pi_magnet_plus->Fill(PK3pi.M());
        }
        if(AchromatCurrent < 0) {
          K3pi_accidentals->fh_M3pi_Aminus->Fill(PK3pi.M());
        }
        if(AchromatCurrent > 0) {
          K3pi_accidentals->fh_M3pi_Aplus->Fill(PK3pi.M());
        }


        if(Kcharge*pion1.GetCharge()==-1 && sevt->track[pi1].iMuon != -1){
          K3pi_accidentals->fh_odd_eop->Fill(pion1.GetEnergyLeftInEcal()/ pion1.GetMomentum());
          K3pi_accidentals->fh_EoP_vs_p_odd_tr->Fill(pion1.GetEnergyLeftInEcal()/ pion1.GetMomentum(), pion1.GetMomentum());
        } else if(Kcharge*pion2.GetCharge()==-1 && sevt->track[pi2].iMuon != -1) {
          K3pi_accidentals->fh_odd_eop->Fill(pion2.GetEnergyLeftInEcal()/ pion2.GetMomentum());
          K3pi_accidentals->fh_EoP_vs_p_odd_tr->Fill(pion2.GetEnergyLeftInEcal()/ pion2.GetMomentum(), pion2.GetMomentum());
        } else if(Kcharge*pion3.GetCharge()==-1 && sevt->track[pi3].iMuon != -1){
          K3pi_accidentals->fh_odd_eop->Fill(pion3.GetEnergyLeftInEcal()/ pion3.GetMomentum());
          K3pi_accidentals->fh_EoP_vs_p_odd_tr->Fill(pion3.GetEnergyLeftInEcal()/ pion3.GetMomentum(), pion3.GetMomentum());
  ...
  pKaon.SetPxPyPzE(0,0,60.,sqrt(60*60 + massKaonC*massKaonC));

  TLorentzVector Pmuee = muon.Momentum + electron1.Momentum + electron2.Momentum;
  TLorentzVector Pee = electron1.Momentum + electron2.Momentum;
  TLorentzVector Pnu = pKaon - muon.Momentum - electron1.Momentum - electron2.Momentum;
  TLorentzVector mc_ee =  True_Momentum[2] + True_Momentum[3];
  TLorentzVector e1nu = electron1.Momentum + Pnu;
  TLorentzVector e2nu = electron2.Momentum + Pnu;
  TLorentzVector munu = muon.Momentum + Pnu;
  ...
  if(electron1.GetMomentum() < 3.  || electron1.GetMomentum() > 50.){return 0;}
  if(electron2.GetMomentum() < 3.  || electron2.GetMomentum() > 50.){return 0;}
  /* if(cutting.muee_P > 66){return 0;} */
  if(Pmuee.P() > 66){return 0;}
  ...
  dir4->Fill3pi(three_pi);
  dir4->FillHist(Pmuee,Pnu, Kcharge);
  dir4->FillAngle(muon.Momentum,Pee);
  dir4->fh_mee->Fill(Pee.M());
  dir4->fh_cda->Fill(sevt->vtx[0].cda);
  ...
  //New 2D plots
  dir4->fh_mee_vs_MM2->Fill(Pee.M(),Pnu.M2());
  dir4->fh_mee_vs_Pt->Fill(  Pee.M(), Pmuee.Pt());
  dir4->fh_mee_vs_zvtx->Fill(Pee.M(), COmPaCt_Z_Vertex);
  dir4->fh_mee_vs_Pel1->Fill(Pee.M(),electron1.GetMomentum());
  dir4->fh_mee_vs_Pel2->Fill(Pee.M(),electron2.GetMomentum());
  dir4->fh_mee_vs_Pmu->Fill( Pee.M(),muon.GetMomentum());
  ...
  dir7->FillHist(Pmuee,Pnu, Kcharge);
  dir7->FillAngle(muon.Momentum,Pee);


  //-    //New 2D plots
  dir7->fh_mee_vs_MM2->Fill(Pee.M(), Pnu.M2());
  dir7->fh_mee_vs_Pt->Fill(Pee.M(),Pmuee.Pt());
  dir7->fh_mee_vs_zvtx->Fill(Pee.M(), COmPaCt_Z_Vertex);
  dir7->fh_mee_vs_Pel1->Fill(Pee.M(),electron1.GetMomentum());
  dir7->fh_mee_vs_Pel2->Fill(Pee.M(),electron2.GetMomentum());
  dir7->fh_mee_vs_Pmu->Fill(Pee.M(),muon.GetMomentum());
  ...
  if(electron1.GetCharge()==electron2.GetCharge() &&
    ...
    TLorentzVector WS_Pmuee = muon.Momentum + electron1.Momentum + electron2.Momentum;
    TLorentzVector WS_Pee = electron1.Momentum + electron2.Momentum;
    TLorentzVector WS_Pnu = pKaon - muon.Momentum - electron1.Momentum - electron2.Momentum;
    TLorentzVector WS_e1nu = electron1.Momentum + WS_Pnu;
    TLorentzVector WS_e2nu = electron2.Momentum + WS_Pnu;
    TLorentzVector WS_munu = muon.Momentum + WS_Pnu;
    ...
    if(fabs(Event_HoDTime) > 3 &&
      ...
      dir19->fh_missing_mass->Fill(WS_Pnu.M2(),w_tot );
      dir19->fh_muee_Pt->Fill(WS_Pmuee.Pt(),w_tot);
      dir19->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
      dir19->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
      dir19->fh_mee->Fill(WS_Pee.M(),w_tot);
      dir19->fh_mee_z_variable->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir19->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

      dir19->fh_muee_M->Fill(WS_Pmuee.M(),w_tot);
      dir19->fh_Pmu_vs_z->Fill(muon.GetMomentum(), WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
      ...
      if(Kcharge>0){
        dir19->fh_mee_z_Kplus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir19->fh_MM2_plus->Fill(WS_Pnu.M2(),w_tot );

      }

      if(Kcharge<0){
        dir19->fh_MM2_minus->Fill(WS_Pnu.M2(),w_tot );
        dir19->fh_mee_z_Kminus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
      }

      if(magnetCurrent < 0){
        dir19->fh_mee_z_magnet_minus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
      }
      if(magnetCurrent > 0){
    ...
    if(fabs(Event_HoDTime) < 3){
      ...
      dir2->fh_missing_mass->Fill(WS_Pnu.M2(),w_tot );
      dir2->fh_muee_Pt->Fill(WS_Pmuee.Pt(),w_tot);
      dir2->fh_muee_M->Fill(WS_Pmuee.M(),w_tot);
      dir2->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
      dir2->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
      dir2->fh_mee->Fill(WS_Pee.M(),w_tot);
      dir2->fh_mee_z_variable->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir2->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

      dir2->fh_Pmu_vs_z->Fill(muon.GetMomentum(), WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
      ...
      if(Kcharge>0){
        dir2->fh_mee_z_Kplus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir2->fh_MM2_plus->Fill(WS_Pnu.M2(),w_tot );

      }

      if(Kcharge<0){
        dir2->fh_MM2_minus->Fill(WS_Pnu.M2(),w_tot );
        dir2->fh_mee_z_Kminus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
      }

      if(magnetCurrent < 0){
        dir2->fh_mee_z_magnet_minus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
      }
      if(magnetCurrent > 0){
      ...
      if(WS_Pmuee.Pt() > 0.010){
        ...
        dir5->fh_missing_mass->Fill(WS_Pnu.M2(),w_tot );
        dir5->fh_muee_Pt->Fill(WS_Pmuee.Pt(),w_tot);
        dir5->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
        dir5->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
        dir5->fh_mee->Fill(WS_Pee.M(),w_tot);
        dir5->fh_mee_z_variable->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir5->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

        dir5->fh_muee_M->Fill(WS_Pmuee.M(),w_tot);
        dir5->fh_Pmu_vs_z->Fill(muon.GetMomentum(), WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        ...
        if(Kcharge>0){
          dir5->fh_mee_z_Kplus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
          dir5->fh_MM2_plus->Fill(WS_Pnu.M2(),w_tot );

        }

        if(Kcharge<0){
          dir5->fh_MM2_minus->Fill(WS_Pnu.M2(),w_tot );
          dir5->fh_mee_z_Kminus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }

        if(magnetCurrent < 0){
          dir5->fh_mee_z_magnet_minus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(magnetCurrent > 0){
      ...
      //Pt > 20 MeV/c
      if(WS_Pmuee.Pt() > 0.020){


        dir6->fh_missing_mass->Fill(WS_Pnu.M2(),w_tot );
        dir6->fh_muee_Pt->Fill(WS_Pmuee.Pt(),w_tot);
        dir6->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
        dir6->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
        dir6->fh_mee->Fill(WS_Pee.M(),w_tot);
        dir6->fh_mee_z_variable->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir6->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

        dir6->fh_muee_M->Fill(WS_Pmuee.M(),w_tot);
        dir6->fh_Pmu_vs_z->Fill(muon.GetMomentum(), WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        ...
        if(Kcharge>0){
          dir6->fh_mee_z_Kplus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
          dir6->fh_MM2_plus->Fill(WS_Pnu.M2(),w_tot );

        }

        if(Kcharge<0){
          dir6->fh_MM2_minus->Fill(WS_Pnu.M2(),w_tot );
          dir6->fh_mee_z_Kminus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }

        if(magnetCurrent < 0){
          dir6->fh_mee_z_magnet_minus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(magnetCurrent > 0){
      ...
      if(WS_Pmuee.Pt() > 0.030){
        ...
        dir9->fh_missing_mass->Fill(WS_Pnu.M2(),w_tot );
        dir9->fh_muee_Pt->Fill(WS_Pmuee.Pt(),w_tot);
        dir9->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
        dir9->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
        dir9->fh_mee->Fill(WS_Pee.M(),w_tot);
        dir9->fh_mee_z_variable->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir9->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

        dir9->fh_muee_M->Fill(WS_Pmuee.M(),w_tot);
        dir9->fh_Pmu_vs_z->Fill(muon.GetMomentum(), WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        ...
        if(Kcharge>0){
          dir9->fh_mee_z_Kplus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
          dir9->fh_MM2_plus->Fill(WS_Pnu.M2(),w_tot );

        }

        if(Kcharge<0){
          dir9->fh_MM2_minus->Fill(WS_Pnu.M2(),w_tot );
          dir9->fh_mee_z_Kminus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }

        if(magnetCurrent < 0){
          dir9->fh_mee_z_magnet_minus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(magnetCurrent > 0){
      ...
      //Pt > 35 MeV/c
      if(WS_Pmuee.Pt() > 0.035){

        dir20->fh_missing_mass->Fill(WS_Pnu.M2(),w_tot );
        dir20->fh_muee_Pt->Fill(WS_Pmuee.Pt(),w_tot);
        dir20->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
        dir20->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
        dir20->fh_mee->Fill(WS_Pee.M(),w_tot);
        dir20->fh_mee_z_variable->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir20->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

        dir20->fh_muee_M->Fill(WS_Pmuee.M(),w_tot);
        dir20->fh_Pmu_vs_z->Fill(muon.GetMomentum(), WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir20->fh_Kaon_Charge->Fill(Kcharge );
        dir20->fh_eop->Fill(muon.GetEnergyLeftInEcal()/muon.GetMomentum(),w_tot);
        dir20->fh_eop->Fill(electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
        dir20->fh_eop->Fill(electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
        dir20->fh_Muee_3pi->Fill( WS_three_pi.M(),w_tot);
        dir20->fh_M3pi_vs_EoP->Fill( WS_three_pi.M(), electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
        dir20->fh_M3pi_vs_EoP->Fill( WS_three_pi.M(), electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
        dir20->fh_munu_M->Fill(WS_munu.M(),w_tot);
        dir20->fh_e1nu_M->Fill(WS_e1nu.M(),w_tot);
        dir20->fh_e2nu_M->Fill(WS_e2nu.M(),w_tot);

        if(Kcharge>0){
          dir20->fh_mee_z_Kplus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
          dir20->fh_MM2_plus->Fill(WS_Pnu.M2(),w_tot );

        }

        if(Kcharge<0){
          dir20->fh_MM2_minus->Fill(WS_Pnu.M2(),w_tot );
          dir20->fh_mee_z_Kminus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }

        if(magnetCurrent < 0){
          dir20->fh_mee_z_magnet_minus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(magnetCurrent > 0){
          dir20->fh_mee_z_magnet_plus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(AchromatCurrent < 0) {
          dir20->fh_mee_z_Aminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(AchromatCurrent > 0) {
          dir20->fh_mee_z_Aplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
      }
      ...
      if(WS_Pmuee.Pt() > 0.04){
        ...
        dir21->fh_missing_mass->Fill(WS_Pnu.M2(),w_tot );
        dir21->fh_muee_Pt->Fill(WS_Pmuee.Pt(),w_tot);
        dir21->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
        dir21->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
        dir21->fh_mee->Fill(WS_Pee.M(),w_tot);
        dir21->fh_mee_z_variable->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir21->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

        dir21->fh_muee_M->Fill(WS_Pmuee.M(),w_tot);
        dir21->fh_Pmu_vs_z->Fill(muon.GetMomentum(), WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir21->fh_Kaon_Charge->Fill(Kcharge );
        dir21->fh_eop->Fill(muon.GetEnergyLeftInEcal()/muon.GetMomentum(),w_tot);
        dir21->fh_eop->Fill(electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
        dir21->fh_eop->Fill(electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
        dir21->fh_Muee_3pi->Fill( WS_three_pi.M(),w_tot);
        dir21->fh_M3pi_vs_EoP->Fill( WS_three_pi.M(), electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
        dir21->fh_M3pi_vs_EoP->Fill( WS_three_pi.M(), electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
        dir21->fh_munu_M->Fill(WS_munu.M(),w_tot);
        dir21->fh_e1nu_M->Fill(WS_e1nu.M(),w_tot);
        dir21->fh_e2nu_M->Fill(WS_e2nu.M(),w_tot);

        if(Kcharge>0){
          dir21->fh_mee_z_Kplus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
          dir21->fh_MM2_plus->Fill(WS_Pnu.M2(),w_tot );

        }

        if(Kcharge<0){
          dir21->fh_MM2_minus->Fill(WS_Pnu.M2(),w_tot );
          dir21->fh_mee_z_Kminus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }

        if(magnetCurrent < 0){
          dir21->fh_mee_z_magnet_minus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(magnetCurrent > 0){
          dir21->fh_mee_z_magnet_plus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(AchromatCurrent < 0) {
          dir21->fh_mee_z_Aminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(AchromatCurrent > 0) {
          dir21->fh_mee_z_Aplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
      }


      //Pt > 45 MeV/c
      if(WS_Pmuee.Pt() > 0.045){

        dir22->fh_missing_mass->Fill(WS_Pnu.M2(),w_tot );
        dir22->fh_muee_Pt->Fill(WS_Pmuee.Pt(),w_tot);
        dir22->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
        dir22->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
        dir22->fh_mee->Fill(WS_Pee.M(),w_tot);
        dir22->fh_mee_z_variable->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir22->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

        dir22->fh_muee_M->Fill(WS_Pmuee.M(),w_tot);
        dir22->fh_Pmu_vs_z->Fill(muon.GetMomentum(), WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir22->fh_Kaon_Charge->Fill(Kcharge );
        dir22->fh_eop->Fill(muon.GetEnergyLeftInEcal()/muon.GetMomentum(),w_tot);
        dir22->fh_eop->Fill(electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
        dir22->fh_eop->Fill(electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
        dir22->fh_Muee_3pi->Fill( WS_three_pi.M(),w_tot);
        dir22->fh_M3pi_vs_EoP->Fill( WS_three_pi.M(), electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
        dir22->fh_M3pi_vs_EoP->Fill( WS_three_pi.M(), electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
        dir22->fh_munu_M->Fill(WS_munu.M(),w_tot);
        dir22->fh_e1nu_M->Fill(WS_e1nu.M(),w_tot);
        dir22->fh_e2nu_M->Fill(WS_e2nu.M(),w_tot);

        if(Kcharge>0){
          dir22->fh_mee_z_Kplus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
          dir22->fh_MM2_plus->Fill(WS_Pnu.M2(),w_tot );

        }

        if(Kcharge<0){
          dir22->fh_MM2_minus->Fill(WS_Pnu.M2(),w_tot );
          dir22->fh_mee_z_Kminus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }

        if(magnetCurrent < 0){
          dir22->fh_mee_z_magnet_minus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(magnetCurrent > 0){
          dir22->fh_mee_z_magnet_plus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(AchromatCurrent < 0) {
          dir22->fh_mee_z_Aminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(AchromatCurrent > 0) {
          dir22->fh_mee_z_Aplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
      }
      //Pt > 50 MeV/c
      if(WS_Pmuee.Pt() > 0.05){

        dir23->fh_missing_mass->Fill(WS_Pnu.M2(),w_tot );
        dir23->fh_muee_Pt->Fill(WS_Pmuee.Pt(),w_tot);
        dir23->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
        dir23->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
        dir23->fh_mee->Fill(WS_Pee.M(),w_tot);
        dir23->fh_mee_z_variable->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir23->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

        dir23->fh_muee_M->Fill(WS_Pmuee.M(),w_tot);
        dir23->fh_Pmu_vs_z->Fill(muon.GetMomentum(), WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        dir23->fh_Kaon_Charge->Fill(Kcharge );
        dir23->fh_eop->Fill(muon.GetEnergyLeftInEcal()/muon.GetMomentum(),w_tot);
        dir23->fh_eop->Fill(electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
        dir23->fh_eop->Fill(electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
        dir23->fh_Muee_3pi->Fill( WS_three_pi.M(),w_tot);
        dir23->fh_M3pi_vs_EoP->Fill( WS_three_pi.M(), electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
        dir23->fh_M3pi_vs_EoP->Fill( WS_three_pi.M(), electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
        dir23->fh_munu_M->Fill(WS_munu.M(),w_tot);
        dir23->fh_e1nu_M->Fill(WS_e1nu.M(),w_tot);
        dir23->fh_e2nu_M->Fill(WS_e2nu.M(),w_tot);

        if(Kcharge>0){
          dir23->fh_mee_z_Kplus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
          dir23->fh_MM2_plus->Fill(WS_Pnu.M2(),w_tot );

        }

        if(Kcharge<0){
          dir23->fh_MM2_minus->Fill(WS_Pnu.M2(),w_tot );
          dir23->fh_mee_z_Kminus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }

        if(magnetCurrent < 0){
          dir23->fh_mee_z_magnet_minus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(magnetCurrent > 0){
          dir23->fh_mee_z_magnet_plus->Fill(WS_Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(AchromatCurrent < 0) {
          dir23->fh_mee_z_Aminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
        if(AchromatCurrent > 0) {
          dir23->fh_mee_z_Aplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
        }
      }
  ...
  dir10->FillHist(Pmuee,Pnu, Kcharge);
  dir10->FillAngle(muon.Momentum,Pee);
  ...
  //-    //New 2D plots
  dir10->fh_mee_vs_MM2->Fill(Pee.M(), Pnu.M2());
  dir10->fh_mee_vs_Pt->Fill(Pee.M(), Pmuee.Pt());
  dir10->fh_mee_vs_zvtx->Fill(Pee.M(), COmPaCt_Z_Vertex);
  dir10->fh_mee_vs_Pel1->Fill(Pee.M(),electron1.GetMomentum());
  dir10->fh_mee_vs_Pel2->Fill(Pee.M(),electron2.GetMomentum());
  dir10->fh_mee_vs_Pmu->Fill(Pee.M(),muon.GetMomentum());
  ...
  //LAST CUT z----- vtx -------------
  if(Pnu.M2() < -0.015 || Pnu.M2() > 0.015){return 0;}

  //dir11->ComputeThreeTrack(k3pi_pion1,k3pi_pion2,k3pi_pion3);
  dir11->Fill3pi(three_pi);
  //--END OF CUT z --------- vtx ---
  double trigger = 1;
  // ------------------------------------------ SS0 --------------------------------------//
  ...
  dir11->FillHist(Pmuee,Pnu, Kcharge);
  dir11->FillAngle(muon.Momentum,Pee);
  ...
  //-    //New 2D plots
  dir11->fh_mee_vs_MM2->Fill(Pee.M(), Pnu.M2());
  dir11->fh_mee_vs_Pt->Fill(Pee.M(), Pmuee.Pt());
  dir11->fh_mee_vs_zvtx->Fill(Pee.M(), COmPaCt_Z_Vertex);
  dir11->fh_mee_vs_Pel1->Fill(Pee.M(),electron1.GetMomentum());
  dir11->fh_mee_vs_Pel2->Fill(Pee.M(),electron2.GetMomentum());
  dir11->fh_mee_vs_Pmu->Fill(Pee.M(),muon.GetMomentum());
  ...
  if(IS_MC){
    ...
    MC_reweight->fh_mee_z_variable->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    MC_reweight->fh_mee->Fill(Pee.M(),w_tot);
    MC_reweight->fh_missing_mass->Fill(Pnu.M2(),w_tot );
    MC_reweight->fh_muee_Pt->Fill(Pmuee.Pt(),w_tot);
  ...
  if(fabs(Event_HoDTime) > 3 && fabs(Event_HoDTime) < 23 ){
    ...
    dir12->FillHist(Pmuee,Pnu, Kcharge);
    dir12->FillAngle(muon.Momentum,Pee);
    ...
    //-    //New 2D plots
    dir12->fh_mee_vs_MM2->Fill(Pee.M(), Pnu.M2());
    dir12->fh_mee_vs_Pt->Fill(Pee.M(), Pmuee.Pt());
    dir12->fh_mee_vs_zvtx->Fill(Pee.M(), COmPaCt_Z_Vertex);
    dir12->fh_mee_vs_Pel1->Fill(Pee.M(),electron1.GetMomentum());
    dir12->fh_mee_vs_Pel2->Fill(Pee.M(),electron2.GetMomentum());
    dir12->fh_mee_vs_Pmu->Fill(Pee.M(),muon.GetMomentum());
  ...
  if(fabs(Kcharge) > 1 ){
    ...
    dir18->fh_missing_mass->Fill(Pnu.M2(),w_tot );
    dir18->fh_muee_Pt->Fill(Pmuee.Pt(),w_tot);
    dir18->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
    dir18->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
    dir18->fh_mee->Fill(Pee.M(),w_tot);
    dir18->fh_mee_z_variable->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);

    dir18->fh_muee_M->Fill(Pmuee.M(),w_tot);
    dir18->fh_Pmu_vs_z->Fill(muon.GetMomentum(), Pee.M2()/(massKaonC*massKaonC),w_tot);
    ...
    if(Kcharge>0){
      dir18->fh_mee_z_Kplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir18->fh_MM2_plus->Fill(Pnu.M2(),w_tot );

    }

    if(Kcharge<0){
      dir18->fh_MM2_minus->Fill(Pnu.M2(),w_tot );
      dir18->fh_mee_z_Kminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }

    if(magnetCurrent < 0){
      dir18->fh_mee_z_magnet_minus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(magnetCurrent > 0){
  ...
  dir13->fh_missing_mass->Fill(Pnu.M2(),w_tot );
  dir13->fh_muee_Pt->Fill(Pmuee.Pt(),w_tot);
  dir13->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
  dir13->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
  dir13->fh_mee->Fill(Pee.M(),w_tot);
  dir13->fh_mee_z_variable->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
  dir13->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);


  dir13->fh_muee_M->Fill(Pmuee.M(),w_tot);
  dir13->fh_Pmu_vs_z->Fill(muon.GetMomentum(), Pee.M2()/(massKaonC*massKaonC),w_tot);
  ...
  if(Kcharge>0){
    dir13->fh_mee_z_Kplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    dir13->fh_MM2_plus->Fill(Pnu.M2(),w_tot );

  }

  if(Kcharge<0){
    dir13->fh_MM2_minus->Fill(Pnu.M2(),w_tot );
    dir13->fh_mee_z_Kminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
  }

  if(magnetCurrent < 0){
    dir13->fh_mee_z_magnet_minus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
  }
  if(magnetCurrent > 0){
  ...
  if(Pmuee.Pt() > 0.010){
    ...
    dir15->fh_missing_mass->Fill(Pnu.M2() ,w_tot);
    dir15->fh_muee_Pt->Fill(Pmuee.Pt(),w_tot);
    dir15->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
    dir15->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
    dir15->fh_mee->Fill(Pee.M(),w_tot);
    dir15->fh_mee_z_variable->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    dir15->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

    dir15->fh_muee_M->Fill(Pmuee.M(),w_tot);
    dir15->fh_Pmu_vs_z->Fill(muon.GetMomentum(), Pee.M2()/(massKaonC*massKaonC),w_tot);
    ...
    if(Kcharge>0){
      dir15->fh_mee_z_Kplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir15->fh_MM2_plus->Fill(Pnu.M2(),w_tot );
    }

    if(Kcharge<0){
      dir15->fh_mee_z_Kminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir15->fh_MM2_minus->Fill(Pnu.M2(),w_tot );
    }

    if(magnetCurrent < 0){
      dir15->fh_mee_z_magnet_minus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(magnetCurrent > 0){
  ...
  if(Pmuee.Pt() > 0.020){
    ...
    dir16->fh_missing_mass->Fill(Pnu.M2() ,w_tot);
    dir16->fh_muee_Pt->Fill(Pmuee.Pt(),w_tot);
    dir16->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
    dir16->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
    dir16->fh_mee->Fill(Pee.M(),w_tot);
    dir16->fh_mee_z_variable->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    dir16->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

    dir16->fh_muee_M->Fill(Pmuee.M(),w_tot);
    dir16->fh_Pmu_vs_z->Fill(muon.GetMomentum(), Pee.M2()/(massKaonC*massKaonC),w_tot);
    ...
    if(Kcharge>0){
      dir16->fh_mee_z_Kplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir16->fh_MM2_plus->Fill(Pnu.M2(),w_tot );
    }

    if(Kcharge<0){
      dir16->fh_mee_z_Kminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir16->fh_MM2_minus->Fill(Pnu.M2(),w_tot );
    }
  ...
  if(Pmuee.Pt() > 0.030){
    ...
    dir17->fh_missing_mass->Fill(Pnu.M2() ,w_tot);
    dir17->fh_muee_Pt->Fill(Pmuee.Pt(),w_tot);
    dir17->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
    dir17->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
    dir17->fh_mee->Fill(Pee.M(),w_tot);
    dir17->fh_mee_z_variable->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    dir17->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

    dir17->fh_muee_M->Fill(Pmuee.M(),w_tot);
    dir17->fh_Pmu_vs_z->Fill(muon.GetMomentum(), Pee.M2()/(massKaonC*massKaonC),w_tot);
    ...
    if(Kcharge>0){
      dir17->fh_mee_z_Kplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir17->fh_MM2_plus->Fill(Pnu.M2(),w_tot );
    }

    if(Kcharge<0){
      dir17->fh_mee_z_Kminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir17->fh_MM2_minus->Fill(Pnu.M2(),w_tot );
    }

    if(magnetCurrent < 0){
      dir17->fh_mee_z_magnet_minus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(magnetCurrent > 0){
  ...
  if(Pmuee.Pt() > 0.035){
    ...
    dir24->ComputeThreeTrack(electron1,electron2,muon);
    dir24->fh_missing_mass->Fill(Pnu.M2() ,w_tot);
    dir24->fh_muee_Pt->Fill(Pmuee.Pt(),w_tot);
    dir24->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
    dir24->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
    dir24->fh_mee->Fill(Pee.M(),w_tot);
    dir24->fh_mee_z_variable->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    dir24->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

    dir24->fh_muee_M->Fill(Pmuee.M(),w_tot);
    dir24->fh_Pmu_vs_z->Fill(muon.GetMomentum(), Pee.M2()/(massKaonC*massKaonC),w_tot);
    dir24->fh_Kaon_Charge->Fill(Kcharge );
    dir24->fh_eop->Fill(muon.GetEnergyLeftInEcal()/muon.GetMomentum(),w_tot);
    dir24->fh_eop->Fill(electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
    dir24->fh_eop->Fill(electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
    dir24->fh_Muee_3pi->Fill( three_pi.M(),w_tot);
    dir24->fh_M3pi_vs_EoP->Fill( three_pi.M(), electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
    dir24->fh_M3pi_vs_EoP->Fill( three_pi.M(), electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
    dir24->fh_munu_M->Fill(munu.M(),w_tot);
    dir24->fh_e1nu_M->Fill(e1nu.M(),w_tot);
    dir24->fh_e2nu_M->Fill(e2nu.M(),w_tot);
    dir24->fh_mc_two_track_23_mass_z_variable->Fill(mc_ee.M()*mc_ee.M()/(0.493677*0.493677));

    if(Kcharge>0){
      dir24->fh_mee_z_Kplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir24->fh_MM2_plus->Fill(Pnu.M2(),w_tot );
    }

    if(Kcharge<0){
      dir24->fh_mee_z_Kminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir24->fh_MM2_minus->Fill(Pnu.M2(),w_tot );
    }

    if(magnetCurrent < 0){
      dir24->fh_mee_z_magnet_minus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(magnetCurrent > 0){
      dir24->fh_mee_z_magnet_plus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(AchromatCurrent < 0) {
      dir24->fh_mee_z_Aminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(AchromatCurrent > 0) {
      dir24->fh_mee_z_Aplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
  ...
  if(Pmuee.Pt() > 0.040){
    ...
    dir25->ComputeThreeTrack(electron1,electron2,muon);
    dir25->fh_missing_mass->Fill(Pnu.M2() ,w_tot);
    dir25->fh_muee_Pt->Fill(Pmuee.Pt(),w_tot);
    dir25->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
    dir25->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
    dir25->fh_mee->Fill(Pee.M(),w_tot);
    dir25->fh_mee_z_variable->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    dir25->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

    dir25->fh_muee_M->Fill(Pmuee.M(),w_tot);
    dir25->fh_Pmu_vs_z->Fill(muon.GetMomentum(), Pee.M2()/(massKaonC*massKaonC),w_tot);
    dir25->fh_Kaon_Charge->Fill(Kcharge );
    dir25->fh_eop->Fill(muon.GetEnergyLeftInEcal()/muon.GetMomentum(),w_tot);
    dir25->fh_eop->Fill(electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
    dir25->fh_eop->Fill(electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
    dir25->fh_Muee_3pi->Fill( three_pi.M(),w_tot);
    dir25->fh_M3pi_vs_EoP->Fill( three_pi.M(), electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
    dir25->fh_M3pi_vs_EoP->Fill( three_pi.M(), electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
    dir25->fh_munu_M->Fill(munu.M(),w_tot);
    dir25->fh_e1nu_M->Fill(e1nu.M(),w_tot);
    dir25->fh_e2nu_M->Fill(e2nu.M(),w_tot);
    dir25->fh_mc_two_track_23_mass_z_variable->Fill(mc_ee.M()*mc_ee.M()/(0.493677*0.493677));

    if(Kcharge>0){
      dir25->fh_mee_z_Kplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir25->fh_MM2_plus->Fill(Pnu.M2(),w_tot );
    }

    if(Kcharge<0){
      dir25->fh_mee_z_Kminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir25->fh_MM2_minus->Fill(Pnu.M2(),w_tot );
    }

    if(magnetCurrent < 0){
      dir25->fh_mee_z_magnet_minus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(magnetCurrent > 0){
      dir25->fh_mee_z_magnet_plus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(AchromatCurrent < 0) {
      dir25->fh_mee_z_Aminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(AchromatCurrent > 0) {
      dir25->fh_mee_z_Aplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
  ...
  if(Pmuee.Pt() > 0.045){
    ...
    dir26->ComputeThreeTrack(electron1,electron2,muon);
    dir26->fh_missing_mass->Fill(Pnu.M2() ,w_tot);
    dir26->fh_muee_Pt->Fill(Pmuee.Pt(),w_tot);
    dir26->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
    dir26->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
    dir26->fh_mee->Fill(Pee.M(),w_tot);
    dir26->fh_mee_z_variable->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    dir26->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

    dir26->fh_muee_M->Fill(Pmuee.M(),w_tot);
    dir26->fh_Pmu_vs_z->Fill(muon.GetMomentum(), Pee.M2()/(massKaonC*massKaonC),w_tot);
    dir26->fh_Kaon_Charge->Fill(Kcharge );
    dir26->fh_eop->Fill(muon.GetEnergyLeftInEcal()/muon.GetMomentum(),w_tot);
    dir26->fh_eop->Fill(electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
    dir26->fh_eop->Fill(electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
    dir26->fh_Muee_3pi->Fill( three_pi.M(),w_tot);
    dir26->fh_M3pi_vs_EoP->Fill( three_pi.M(), electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
    dir26->fh_M3pi_vs_EoP->Fill( three_pi.M(), electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
    dir26->fh_munu_M->Fill(munu.M(),w_tot);
    dir26->fh_e1nu_M->Fill(e1nu.M(),w_tot);
    dir26->fh_e2nu_M->Fill(e2nu.M(),w_tot);
    dir26->fh_mc_two_track_23_mass_z_variable->Fill(mc_ee.M()*mc_ee.M()/(0.493677*0.493677));

    if(Kcharge>0){
      dir26->fh_mee_z_Kplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir26->fh_MM2_plus->Fill(Pnu.M2(),w_tot );
    }

    if(Kcharge<0){
      dir26->fh_mee_z_Kminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir26->fh_MM2_minus->Fill(Pnu.M2(),w_tot );
    }

    if(magnetCurrent < 0){
      dir26->fh_mee_z_magnet_minus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(magnetCurrent > 0){
      dir26->fh_mee_z_magnet_plus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(AchromatCurrent < 0) {
      dir26->fh_mee_z_Aminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(AchromatCurrent > 0) {
      dir26->fh_mee_z_Aplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
  ...
  if(Pmuee.Pt() > 0.05){
    ...
    dir27->ComputeThreeTrack(electron1,electron2,muon);
    dir27->fh_missing_mass->Fill(Pnu.M2() ,w_tot);
    dir27->fh_muee_Pt->Fill(Pmuee.Pt(),w_tot);
    dir27->fh_COmPaCt_Z_Vertex->Fill(COmPaCt_Z_Vertex,w_tot);
    dir27->fh_Mu_momentum->Fill(muon.GetMomentum(),w_tot);
    dir27->fh_mee->Fill(Pee.M(),w_tot);
    dir27->fh_mee_z_variable->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    dir27->fh_HoDTotTime->Fill(Event_HoDTime,w_tot);

    dir27->fh_muee_M->Fill(Pmuee.M(),w_tot);
    dir27->fh_Pmu_vs_z->Fill(muon.GetMomentum(), Pee.M2()/(massKaonC*massKaonC),w_tot);
    dir27->fh_Kaon_Charge->Fill(Kcharge );
    dir27->fh_eop->Fill(muon.GetEnergyLeftInEcal()/muon.GetMomentum(),w_tot);
    dir27->fh_eop->Fill(electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
    dir27->fh_eop->Fill(electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
    dir27->fh_Muee_3pi->Fill( three_pi.M(),w_tot);
    dir27->fh_M3pi_vs_EoP->Fill( three_pi.M(), electron2.GetEnergyLeftInEcal()/electron2.GetMomentum(),w_tot);
    dir27->fh_M3pi_vs_EoP->Fill( three_pi.M(), electron1.GetEnergyLeftInEcal()/electron1.GetMomentum(),w_tot);
    dir27->fh_munu_M->Fill(munu.M(),w_tot);
    dir27->fh_e1nu_M->Fill(e1nu.M(),w_tot);
    dir27->fh_e2nu_M->Fill(e2nu.M(),w_tot);
    dir27->fh_mc_two_track_23_mass_z_variable->Fill(mc_ee.M()*mc_ee.M()/(0.493677*0.493677));

    if(Kcharge>0){
      dir27->fh_mee_z_Kplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir27->fh_MM2_plus->Fill(Pnu.M2(),w_tot );
    }

    if(Kcharge<0){
      dir27->fh_mee_z_Kminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
      dir27->fh_MM2_minus->Fill(Pnu.M2(),w_tot );
    }

    if(magnetCurrent < 0){
      dir27->fh_mee_z_magnet_minus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(magnetCurrent > 0){
      dir27->fh_mee_z_magnet_plus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(AchromatCurrent < 0) {
      dir27->fh_mee_z_Aminus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
    if(AchromatCurrent > 0) {
      dir27->fh_mee_z_Aplus->Fill(Pee.M2()/(massKaonC*massKaonC),w_tot);
    }
  ...
  if( 15304 < sbur->nrun && sbur->nrun <= 15582){
    if(((sevt->trigWord)>>3)&0x1) {
      ...
      if( (sevt->pu[3].chan[5]>>4)&0x1 ||
          ...
          (sevt->pu[6].chan[5]>>13)&0x1 ) {
        if( ((sevt->trigWord)>>4)&0x1 ) //
          dir->fh_SS0_MB_1TRK_P->Fill(trigger);
        if( ((sevt->trigWord)>>1)&0x1  )
          dir->fh_SS0_MB_1VTX->Fill(trigger);

        if( ((sevt->trigWord))&0x1    || ((sevt->trigWord)>>1)&0x1 || ((sevt->trigWord)>>4)&0x1 )
          dir->fh_SS0_full_trig->Fill(trigger);
  ...
  if( 15633 <= sbur->nrun && sbur->nrun <= 15703){
    if(((sevt->trigWord)>>3)&0x1) {
      ...
      if( (sevt->pu[3].chan[5]>>4)&0x1 ||
          ...
          (sevt->pu[6].chan[5]>>13)&0x1 ) {
        if( ((sevt->trigWord)>>4)&0x1 ) //
          dir->fh_SS1_MB_1TRK_P->Fill(trigger);
        if( ((sevt->trigWord)>>1)&0x1  )
          dir->fh_SS1_MB_1VTX->Fill(trigger);
        if( ((sevt->trigWord))&0x1    || ((sevt->trigWord)>>1)&0x1 || ((sevt->trigWord)>>4)&0x1 )
          dir->fh_SS1_full_trig->Fill(trigger);
      }
    }
  }
  //------------------------------------- SS2 -----------------------------------------------//
  if( 15717 <= sbur->nrun && sbur->nrun <= 15777){
    if(((sevt->trigWord)>>3)&0x1) {
      ...
      if( (sevt->pu[3].chan[5]>>4)&0x1 ||
          ...
          (sevt->pu[6].chan[5]>>13)&0x1 ) {
        if( ((sevt->trigWord)>>4)&0x1 ) //
          dir->fh_SS2_MB_1TRK_P->Fill(trigger);
        if( ((sevt->trigWord)>>1)&0x1  )
          dir->fh_SS2_MB_1VTX->Fill(trigger);
        if( ((sevt->trigWord))&0x1    || ((sevt->trigWord)>>1)&0x1 || ((sevt->trigWord)>>4)&0x1 )
          dir->fh_SS2_full_trig->Fill(trigger);
      }
    }
  }
  //------------------------------------- SS3 -----------------------------------------------//
  if( 15778 <= sbur->nrun && sbur->nrun <= 15790){
    if(((sevt->trigWord)>>3)&0x1) {
      ...
      if( (sevt->pu[3].chan[5]>>4)&0x1 ||
          ...
          (sevt->pu[6].chan[5]>>13)&0x1 ) {
        if( ((sevt->trigWord)>>4)&0x1 ) //
          dir->fh_SS3_MB_1TRK_P->Fill(trigger);
        if( ((sevt->trigWord)>>1)&0x1  )
          dir->fh_SS3_MB_1VTX->Fill(trigger);
        if( ((sevt->trigWord))&0x1    || ((sevt->trigWord)>>1)&0x1 || ((sevt->trigWord)>>4)&0x1 )
          dir->fh_SS3_full_trig->Fill(trigger);
      }
    }
  }
  ...
  if( 16121 <= sbur->nrun && sbur->nrun <= 16383){
    if(((sevt->trigWord)>>3)&0x1) {
      ...
      if( (sevt->pu[3].chan[5]>>4)&0x1 ||
          ...
          (sevt->pu[6].chan[5]>>13)&0x1 ) {
        if( ((sevt->trigWord)>>4)&0x1 ) //
          dir->fh_SS4_MB_1TRK_P->Fill(trigger);
        if( ((sevt->trigWord)>>1)&0x1  )
          dir->fh_SS4_MB_1VTX->Fill(trigger);
        if( ((sevt->trigWord))&0x1    || ((sevt->trigWord)>>1)&0x1 || ((sevt->trigWord)>>4)&0x1 )
          dir->fh_SS4_full_trig->Fill(trigger);
      }
    }
  }
  ...
  if( 16428 <= sbur->nrun && sbur->nrun <= 16585){
    if(((sevt->trigWord)>>3)&0x1) {
      ...
      if( (sevt->pu[3].chan[5]>>4)&0x1 ||
          ...
          (sevt->pu[6].chan[5]>>13)&0x1 ) {
        if( ((sevt->trigWord)>>4)&0x1 ) //
          dir->fh_SS5_MB_1TRK_P->Fill(trigger);
        if( ((sevt->trigWord)>>1)&0x1  )
          dir->fh_SS5_MB_1VTX->Fill(trigger);
        if( ((sevt->trigWord))&0x1    || ((sevt->trigWord)>>1)&0x1 || ((sevt->trigWord)>>4)&0x1 )
          dir->fh_SS5_full_trig->Fill(trigger);
      }
    }
  }
  ...
  if( 16586 <= sbur->nrun && sbur->nrun <= 16709){
    if(((sevt->trigWord)>>3)&0x1) {
      ...
      if( (sevt->pu[3].chan[5]>>4)&0x1 ||
          ...
          (sevt->pu[6].chan[5]>>13)&0x1 ) {
        if( ((sevt->trigWord)>>4)&0x1 ) //
          dir->fh_SS6_MB_1TRK_P->Fill(trigger);
        if( ((sevt->trigWord)>>1)&0x1  )
          dir->fh_SS6_MB_1VTX->Fill(trigger);
        if( ((sevt->trigWord))&0x1    || ((sevt->trigWord)>>1)&0x1 || ((sevt->trigWord)>>4)&0x1 )
          dir->fh_SS6_full_trig->Fill(trigger);
      }
    }
  }
  ...
  if( 16722 <= sbur->nrun && sbur->nrun <= 16801){
    if(((sevt->trigWord)>>3)&0x1) {
      ...
      if( (sevt->pu[3].chan[5]>>4)&0x1 ||
          ...
          (sevt->pu[6].chan[5]>>13)&0x1 ) {
        if( ((sevt->trigWord)>>4)&0x1 ) //
          dir->fh_SS7_MB_1TRK_P->Fill(trigger);
        if( ((sevt->trigWord)>>1)&0x1  )
          dir->fh_SS7_MB_1VTX->Fill(trigger);
        if( ((sevt->trigWord))&0x1    || ((sevt->trigWord)>>1)&0x1 || ((sevt->trigWord)>>4)&0x1 )
          dir->fh_SS7_full_trig->Fill(trigger);
      }
    }
  }
  ...
  if( 16802 <= sbur->nrun && sbur->nrun <= 16905){
    if(((sevt->trigWord)>>3)&0x1) {
      ...
      if( (sevt->pu[3].chan[5]>>4)&0x1 ||
          ...
          (sevt->pu[6].chan[5]>>13)&0x1 ) {
        if( ((sevt->trigWord)>>4)&0x1 ) //
          dir->fh_SS8_MB_1TRK_P->Fill(trigger);
        if( ((sevt->trigWord)>>1)&0x1  )
          dir->fh_SS8_MB_1VTX->Fill(trigger);
        if( ((sevt->trigWord))&0x1    || ((sevt->trigWord)>>1)&0x1 || ((sevt->trigWord)>>4)&0x1 )
          dir->fh_SS8_full_trig->Fill(trigger);
      }
    }
  }
