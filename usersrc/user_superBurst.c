...
/*---------- Add user C code here ----------*/
    ...
    if(runNo != PrevrunNo && PrevrunNo != 0){
        printf("Prev run = %d - run - %d - Nburst per run = %d - Total Nbursts = %d - NselectedEvents = %d\n", PrevrunNo, runNo, noBurstsPerRun, noBursts, noSelectedEvents);
