...
Hist_dir::Hist_dir(const std::string& dir_Name, int type){
  ...
  if(ftype==0){
    ...
    fh_mc_mee_z_Kplus       = new TH1F("mc_mee_z_Kplus","Invariant mass of the electron pair in terms of the z variable for K^{+};z;Nevents",25,0,0.5);
    fh_mc_mee_z_Kminus      = new TH1F("mc_mee_z_Kminus","Invariant mass of the electron pair in terms of the z variable for K^{-};z;Nevents",25,0,0.5);
    fh_mc_mee_z_magnet_plus = new TH1F("mc_mee_z_magnet_plus","Invariant mass of the electron pair in terms of the z variable for + magnet polarity;z;Nevents",25,0,0.5);
    fh_mc_mee_z_magnet_minus= new TH1F("mc_mee_z_magnet_minus","Invariant mass of the electron pair in terms of the z variable for - magnet polarity;z;Nevents",25,0,0.5);
    fh_mc_mee_z_Aminus= new TH1F("mc_mee_z_Aminus","Invariant mass of the electron pair in terms of the z variable for - achromat polarity;z;Nevents",25,0,0.5);
    fh_mc_mee_z_Aplus= new TH1F("mc_mee_z_Aplus","Invariant mass of the electron pair in terms of the z variable for + achromat polarity;z;Nevents",25,0,0.5);

    fh_M3pi_Kplus       = new TH1F("M3pi_Kplus","M 3 #pi for K^{+};z;Nevents",1000,-1,1);
    fh_M3pi_Kminus      = new TH1F("M3pi_Kminus","M 3 #pi for K^{-};z;Nevents",1000,-1,1);
    fh_M3pi_magnet_plus = new TH1F("M3pi_magnet_plus","M 3 #pi for + magnet polarity;z;Nevents",1000,-1,1);
    fh_M3pi_magnet_minus= new TH1F("M3pi_magnet_minus","M 3 #pi for - magnet polarity;z;Nevents",1000,-1,1);
    fh_M3pi_Aminus      = new TH1F("M3pi_Aminus","M 3 #pi for - achromat polarity;z;Nevents",1000,-1,1);
  ...
  if(ftype==1){
    ...
    fh_eop               = new TH1F("Track_Eratio","Track E/p ;E/p;Nevents",120.,0.,1.2);
    fh_odd_eop           = new TH1F("odd_Eratio","E/p for the odd track in the k3pi selection",120,0.,1.2);
    ...
    fh_muee_Pt = new TH1F("muee_Pt","Transverse momentum of 3#pi ;Pt_{#mu e e}[GeV];Nevents",60,0,0.3);
  ...
  if(ftype==2){
    ...
    fh_eop               = new TH1F("Track_Eratio","Track E/p ;E/p;Nevents",120.,0.,1.2);
    fh_Mu_eop            = new TH1F("Mu_Eratio","Muon E/p ;E/p;Nevents",120.,0.,1.2);
    fh_Electron_eop      = new TH1F("Electron_Eratio", "Electron E/p ;E/p;Nevents",120,0.,1.2);
    fh_odd_eop           = new TH1F("odd_Eratio","E/p for the odd track in the k3pi selection",120,0.,1.2);
    fh_COmPaCt_Z_Vertex  = new TH1F("COmPaCt_Z_Vertex","Three track vertex from COmPaCt",150,-4000.,11000.);
    ...
    fh_mee_vs_Pt   = new TH2F("mee_vs_Pt"  ,"Invariant mass of the electron pair vs Total transverse momentum ",50,0.,0.5, 30, 0, 0.3);
    ...
    fh_mc_mee_z_Aminus= new TH1F("mc_mee_z_Aminus","Invariant mass of the electron pair in terms of the z variable for - achromat polarity;z;Nevents",25,0,0.5);
    fh_mc_mee_z_Aplus= new TH1F("mc_mee_z_Aplus","Invariant mass of the electron pair in terms of the z variable for + achromat polarity;z;Nevents",25,0,0.5);
    //fh_mee_z_Aminus= new TH1F("mee_z_Aminus","Invariant mass of the electron pair in terms of the z variable for - achromat polarity;z;Nevents",25,0,0.5);
    //fh_mee_z_Aplus= new TH1F("mee_z_Aplus","Invariant mass of the electron pair in terms of the z variable for + achromat polarity;z;Nevents",25,0,0.5);
  }
  if(ftype==3){
    fh_missing_mass = new TH1F("missing_mass","Missing mass squared;M^{2}_{miss};Nevents",100,-0.05,0.05);
    fh_mee = new TH1F("mee","Invariant mass of the electron pair ",50,0.,0.5);
...
void Hist_dir::AddToFile(TFile* file){
  ...
  if(ftype==0){
    ...
    fh_mc_mee_z_Kplus       ->Write();
    fh_mc_mee_z_Kminus      ->Write();
    fh_mc_mee_z_magnet_plus ->Write();
    fh_mc_mee_z_magnet_minus->Write();
    fh_mc_mee_z_Aplus ->Write();
    fh_mc_mee_z_Aminus ->Write();

    fh_M3pi_Kplus       ->Write();
    fh_M3pi_Kminus      ->Write();
    fh_M3pi_magnet_plus ->Write();
    fh_M3pi_magnet_minus->Write();
    fh_M3pi_Aminus      ->Write();
    fh_M3pi_Aplus       ->Write();
  ...
  if(ftype==3){
    ...
    fh_mee_z_Aminus->Write();
    fh_mee_z_Aplus->Write();
...
Hist_dir::~Hist_dir(){
  if(ftype==0){
    ...
    delete fh_mc_mee_z_Kplus       ;
    delete fh_mc_mee_z_Kminus      ;
    delete fh_mc_mee_z_magnet_plus ;
    delete fh_mc_mee_z_magnet_minus;
    delete fh_mc_mee_z_Aplus ;
    delete fh_mc_mee_z_Aminus;

    delete fh_mee_z_Aplus ;
    delete fh_mee_z_Aminus;

    delete fh_M3pi_Kplus       ;
    delete fh_M3pi_Kminus      ;
    delete fh_M3pi_magnet_plus ;
    delete fh_M3pi_magnet_minus;
    delete fh_M3pi_Aminus      ;
    delete fh_M3pi_Aplus       ;
